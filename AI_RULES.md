...
AI **wajib** membaca semua file skill di folder `@agents/AI-SKILLS/` dan subfoldernya. Berikut adalah poin besar dari tiap *skill* yang tersedia:
...
- **CONTEXT7.md:** Digunakan untuk mencari dokumentasi resmi teknologi utama proyek (Laravel, React, dll).
- **FIRECRAWL.md:** Digunakan untuk *web scraping* atau mencari dokumentasi dari sumber luar jika Context7 tidak mencukupi.
...
- **RTK_SKILL.md:** Panduan untuk inisialisasi Repository Toolkit (RTK) demi optimasi token terminal.
- **AGENTS.md / WORKFLOW_MODE.md / AI_SETUP_MACHINE.md:** Aturan terkait alur kerja AI, penyiapan lingkungan (*environment*), dan persona.
